        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="border-t hairline pt-3.5">
              <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.2em] text-orange mb-2.5">
                Selling Points
              </p>
              {p.sellingPoints.map((pt, i) => (
                <div key={i} className="flex gap-2.5 items-baseline mb-1.5">
                  ...
                  <span className="text-[12px] text-ink-soft leading-snug">{pt}</span>
                </div>
              ))}
            </div>

            <div className="border-t hairline pt-3.5">
              <p className="font-mono text-[10px] font-semibold uppercase tracking-[0.2em] text-orange mb-2">
                Image Direction
              </p>
